...
class AscendFusedMoE310(FusedMoE):
    def __init__(self, *args, **kwargs):
        ...
        from vllm_ascend.ops.fused_moe.fused_moe import _get_layer_attr_or_default, _make_ascend_moe_runner
...
class AscendSharedFusedMoE310(SharedFusedMoE, AscendFusedMoE310):
    def __init__(
        ...
        **kwargs,
        ...
        from vllm_ascend.ops.fused_moe.fused_moe import _make_ascend_moe_runner
